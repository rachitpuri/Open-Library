...
<div class ="container" align="center">		
		<div class ="login" style="width:400px; height:365px; padding-top:200px; background:#E8E8E8; margin:20px">
		...
		<div>create an account - <a href="signup.jsp">signup</a></div>
		</div>
		<a type="button" style="top:10px; right:10px; float:right; 
		position:absolute" class="btn btn-primary" href="admin.jsp">Admin-login</a>
</div>
